...
function ActivityComponent_ng_template_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ActivityComponent_ng_template_46_Conditional_0_Template, 2, 1, "div", 48)(1, ActivityComponent_ng_template_46_Conditional_1_Template, 2, 1, "div", 49)(2, ActivityComponent_ng_template_46_Conditional_2_Template, 2, 1, "div", 50);
  }
  if (rf & 2) {
...
function ActivityComponent_ng_template_54_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ActivityComponent_ng_template_54_span_0_Template, 2, 0, "span", 51)(1, ActivityComponent_ng_template_54_span_1_Template, 2, 2, "span", 52);
  }
  if (rf & 2) {
...
function ActivityComponent_ng_template_56_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "span")(1, "button", 53);
    ...
    \u0275\u0275element(2, "i", 54);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ActivityComponent_ng_template_56_button_3_Template, 2, 0, "button", 55)(4, ActivityComponent_ng_template_56_button_4_Template, 2, 0, "button", 56);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, ActivityComponent_ng_template_56_div_5_Template, 2, 0, "div", 57);
  }
  if (rf & 2) {
...
function ActivityComponent_ng_template_57_option_97_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", user_r28.nom, " ", user_r28.prenom, " ");
  }
}
function ActivityComponent_ng_template_57_div_98_Template(rf, ctx) {
  if (rf & 1) {
...
function ActivityComponent_ng_template_57_div_103_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 98)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ActivityComponent_ng_template_57_span_106_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 99);
  }
}
function ActivityComponent_ng_template_57_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(2, "span", 64)(3, "i", 32);
    \u0275\u0275text(4, "close");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(5, "div", 65)(6, "h4");
    ...
    \u0275\u0275elementStart(9, "div", 17)(10, "div", 67)(11, "label");
    \u0275\u0275text(12, "Nom ");
    \u0275\u0275elementStart(13, "span", 68);
    \u0275\u0275text(14, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(15, "input", 69);
    \u0275\u0275template(16, ActivityComponent_ng_template_57_Conditional_16_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 67)(18, "label");
    \u0275\u0275text(19, "Titre ");
    \u0275\u0275elementStart(20, "span", 68);
    \u0275\u0275text(21, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(22, "input", 71);
    \u0275\u0275template(23, ActivityComponent_ng_template_57_Conditional_23_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 17)(25, "div", 67)(26, "label");
    \u0275\u0275text(27, "Lieu ");
    \u0275\u0275elementStart(28, "span", 68);
    \u0275\u0275text(29, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(30, "input", 72);
    \u0275\u0275template(31, ActivityComponent_ng_template_57_Conditional_31_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "div", 67)(33, "label");
    \u0275\u0275text(34, "Description ");
    \u0275\u0275elementStart(35, "span", 68);
    \u0275\u0275text(36, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(37, "input", 73);
    \u0275\u0275template(38, ActivityComponent_ng_template_57_Conditional_38_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 74)(40, "label");
    \u0275\u0275text(41, "Objectif Participant ");
    \u0275\u0275elementStart(42, "span", 68);
    \u0275\u0275text(43, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(44, "input", 75);
    \u0275\u0275template(45, ActivityComponent_ng_template_57_Conditional_45_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 17)(47, "div", 67)(48, "label");
    \u0275\u0275text(49, "Date D\xE9but ");
    \u0275\u0275elementStart(50, "span", 68);
    \u0275\u0275text(51, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(52, "input", 76);
    \u0275\u0275template(53, ActivityComponent_ng_template_57_Conditional_53_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "div", 67)(55, "label");
    \u0275\u0275text(56, "Date Fin ");
    \u0275\u0275elementStart(57, "span", 68);
    \u0275\u0275text(58, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(59, "input", 77);
    \u0275\u0275template(60, ActivityComponent_ng_template_57_Conditional_60_Template, 2, 0, "small", 70)(61, ActivityComponent_ng_template_57_Conditional_61_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(62, "div", 17)(63, "div", 67)(64, "label");
    \u0275\u0275text(65, "Entite ");
    \u0275\u0275elementStart(66, "span", 68);
    \u0275\u0275text(67, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(68, "select", 78)(69, "option", 79);
    \u0275\u0275text(70, "-- S\xE9lectionnez une entite --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(71, ActivityComponent_ng_template_57_option_71_Template, 2, 2, "option", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "div", 81)(73, "label");
    \u0275\u0275text(74, "Salle");
    \u0275\u0275elementStart(75, "span", 68);
    \u0275\u0275text(76, " * ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(77, "select", 82)(78, "option", 79);
    \u0275\u0275text(79, "-- S\xE9lectionnez une salle --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(80, ActivityComponent_ng_template_57_option_80_Template, 2, 2, "option", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(81, "div", 81)(82, "label");
    \u0275\u0275text(83, "Type d'activit\xE9");
    \u0275\u0275elementStart(84, "span", 68);
    \u0275\u0275text(85, " * ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(86, "select", 83)(87, "option", 79);
    \u0275\u0275text(88, "-- S\xE9lectionnez un type --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(89, ActivityComponent_ng_template_57_option_89_Template, 2, 2, "option", 80);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(90, "div", 17)(91, "div", 67)(92, "label");
    \u0275\u0275text(93, "Superviseur / Valideur");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(94, "select", 84);
    \u0275\u0275listener("change", function ActivityComponent_ng_template_57_Template_select_change_94_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onSuperviseurSelected($event));
    });
    \u0275\u0275elementStart(95, "option", 85);
    \u0275\u0275text(96, "-- S\xE9lectionnez un superviseur --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(97, ActivityComponent_ng_template_57_option_97_Template, 2, 3, "option", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(98, ActivityComponent_ng_template_57_div_98_Template, 5, 0, "div", 86);
    \u0275\u0275elementStart(99, "div", 87)(100, "label", 88);
    \u0275\u0275text(101, "Fichier joint :");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(102, "input", 89);
    \u0275\u0275listener("change", function ActivityComponent_ng_template_57_Template_input_change_102_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onFileSelected($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275template(103, ActivityComponent_ng_template_57_div_103_Template, 3, 1, "div", 90);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(104, "div", 91)(105, "button", 92);
    \u0275\u0275template(106, ActivityComponent_ng_template_57_span_106_Template, 1, 0, "span", 93);
    \u0275\u0275text(107);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(108, "button", 94);
    \u0275\u0275listener("click", function ActivityComponent_ng_template_57_Template_button_click_108_listener() {
      const modal_r24 = \u0275\u0275restoreView(_r23).$implicit;
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(8);
    \u0275\u0275property("ngForOf", ctx_r2.utilisateursPersonnels);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.showCommentaire);
    \u0275\u0275advance(5);
...
function ActivityComponent_ng_template_59_option_75_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const entite_r31 = ctx.$implicit;
    \u0275\u0275property("value", entite_r31.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(entite_r31.nom);
  }
}
...
function ActivityComponent_ng_template_59_option_85_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const salles_r32 = ctx.$implicit;
    \u0275\u0275property("value", salles_r32.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(salles_r32.nom);
  }
}
...
function ActivityComponent_ng_template_59_option_95_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const typeActivites_r33 = ctx.$implicit;
    \u0275\u0275property("value", typeActivites_r33.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(typeActivites_r33.type);
  }
}
...
function ActivityComponent_ng_template_59_option_105_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const etapes_r34 = ctx.$implicit;
    \u0275\u0275property("ngValue", etapes_r34.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(etapes_r34.nom);
  }
}
...
function ActivityComponent_ng_template_59_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 62)(1, "h4", 100)(2, "div", 101)(3, "div", 102)(4, "div", 103);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()()()();
    ...
    \u0275\u0275listener("click", function ActivityComponent_ng_template_59_Template_button_click_6_listener() {
      ...
      return \u0275\u0275resetView(modal_r30.dismiss("Cross click"));
    });
    \u0275\u0275elementStart(7, "span", 64)(8, "i", 32);
    \u0275\u0275text(9, "close");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(10, "div", 65)(11, "form", 104);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 17)(15, "div", 67)(16, "label");
    \u0275\u0275text(17, "Nom ");
    \u0275\u0275elementStart(18, "span", 68);
    \u0275\u0275text(19, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(20, "input", 69);
    \u0275\u0275template(21, ActivityComponent_ng_template_59_Conditional_21_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(26, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(27, "input", 71);
    \u0275\u0275template(28, ActivityComponent_ng_template_59_Conditional_28_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 17)(30, "div", 67)(31, "label");
    \u0275\u0275text(32, "Lieu ");
    \u0275\u0275elementStart(33, "span", 68);
    \u0275\u0275text(34, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(35, "input", 72);
    \u0275\u0275template(36, ActivityComponent_ng_template_59_Conditional_36_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 67)(38, "label");
    \u0275\u0275text(39, "Description ");
    \u0275\u0275elementStart(40, "span", 68);
    \u0275\u0275text(41, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(42, "input", 73);
    \u0275\u0275template(43, ActivityComponent_ng_template_59_Conditional_43_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "div", 74)(45, "label");
    \u0275\u0275text(46, "Objectif Participant ");
    \u0275\u0275elementStart(47, "span", 68);
    \u0275\u0275text(48, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(49, "input", 75);
    \u0275\u0275template(50, ActivityComponent_ng_template_59_Conditional_50_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "div", 17)(52, "div", 67)(53, "label");
    \u0275\u0275text(54, "Date D\xE9but ");
    \u0275\u0275elementStart(55, "span", 68);
    \u0275\u0275text(56, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(57, "input", 76);
    \u0275\u0275template(58, ActivityComponent_ng_template_59_Conditional_58_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "div", 67)(60, "label");
    \u0275\u0275text(61, "Date Fin ");
    \u0275\u0275elementStart(62, "span", 68);
    \u0275\u0275text(63, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(64, "input", 77);
    \u0275\u0275template(65, ActivityComponent_ng_template_59_Conditional_65_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(66, "div", 17)(67, "div", 67)(68, "label");
    \u0275\u0275text(69, "Entite ");
    \u0275\u0275elementStart(70, "span", 68);
    \u0275\u0275text(71, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "select", 78)(73, "option", 79);
    \u0275\u0275text(74, "-- S\xE9lectionnez une entite --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(75, ActivityComponent_ng_template_59_option_75_Template, 2, 2, "option", 80);
    \u0275\u0275elementEnd();
    \u0275\u0275template(76, ActivityComponent_ng_template_59_Conditional_76_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "div", 81)(78, "label");
    \u0275\u0275text(79, "Salle");
    \u0275\u0275elementStart(80, "span", 68);
    \u0275\u0275text(81, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(82, "select", 82)(83, "option", 79);
    \u0275\u0275text(84, "-- S\xE9lectionnez une salle --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(85, ActivityComponent_ng_template_59_option_85_Template, 2, 2, "option", 80);
    \u0275\u0275elementEnd();
    \u0275\u0275template(86, ActivityComponent_ng_template_59_Conditional_86_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "div", 81)(88, "label");
    \u0275\u0275text(89, "Type d'activite");
    \u0275\u0275elementStart(90, "span", 68);
    \u0275\u0275text(91, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(92, "select", 83)(93, "option", 79);
    \u0275\u0275text(94, "-- S\xE9lectionnez un type --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(95, ActivityComponent_ng_template_59_option_95_Template, 2, 2, "option", 80);
    \u0275\u0275elementEnd();
    \u0275\u0275template(96, ActivityComponent_ng_template_59_Conditional_96_Template, 2, 0, "small", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(97, "div", 74)(98, "label");
    \u0275\u0275text(99, "Etape ");
    \u0275\u0275elementStart(100, "span", 68);
    \u0275\u0275text(101, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(102, "select", 107);
    ...
    \u0275\u0275elementStart(103, "option", 79);
    \u0275\u0275text(104, "-- S\xE9lectionnez un ou plusieurs Etape --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(105, ActivityComponent_ng_template_59_option_105_Template, 2, 2, "option", 108);
    \u0275\u0275elementEnd();
    \u0275\u0275template(106, ActivityComponent_ng_template_59_Conditional_106_Template, 2, 0, "small", 70);
    \u0275\u0275elementStart(107, "div", 109);
    \u0275\u0275text(108, "Maintenez Ctrl (ou Cmd sur Mac) pour s\xE9lectionner plusieurs options.");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(109, "div", 91)(110, "button", 92);
    \u0275\u0275template(111, ActivityComponent_ng_template_59_span_111_Template, 1, 0, "span", 93);
    \u0275\u0275text(112);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(113, "button", 94);
    \u0275\u0275listener("click", function ActivityComponent_ng_template_59_Template_button_click_113_listener() {
      const modal_r30 = \u0275\u0275restoreView(_r29).$implicit;
      return \u0275\u0275resetView(modal_r30.close("Close click"));
    });
    \u0275\u0275text(114, "Fermer");
    \u0275\u0275elementEnd()()()();
  }
...
function ActivityComponent_ng_template_61_option_70_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const entite_r37 = ctx.$implicit;
    \u0275\u0275property("value", entite_r37.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(entite_r37.nom);
  }
}
function ActivityComponent_ng_template_61_option_79_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const salles_r38 = ctx.$implicit;
    \u0275\u0275property("value", salles_r38.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(salles_r38.nom);
  }
}
function ActivityComponent_ng_template_61_option_88_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const typeActivites_r39 = ctx.$implicit;
    \u0275\u0275property("value", typeActivites_r39.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(typeActivites_r39.type);
  }
}
function ActivityComponent_ng_template_61_option_97_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const etapes_r40 = ctx.$implicit;
    \u0275\u0275property("ngValue", etapes_r40.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(etapes_r40.nom);
  }
}
function ActivityComponent_ng_template_61_Template(rf, ctx) {
  if (rf & 1) {
    const _r35 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 62)(1, "h4", 100)(2, "div", 101)(3, "div", 102)(4, "div", 103)(5, "h3", 111);
    ...
    \u0275\u0275elementStart(9, "span", 64)(10, "i", 32);
    \u0275\u0275text(11, "close");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(12, "div", 65)(13, "form", 112)(14, "div", 105);
    \u0275\u0275element(15, "input", 106);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 17)(17, "div", 67)(18, "label");
    \u0275\u0275text(19, "Nom ");
    \u0275\u0275elementStart(20, "span", 68);
    \u0275\u0275text(21, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(22, "input", 113);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "div", 67)(24, "label");
    \u0275\u0275text(25, "Titre ");
    \u0275\u0275elementStart(26, "span", 68);
    \u0275\u0275text(27, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(28, "input", 114);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 17)(30, "div", 67)(31, "label");
    \u0275\u0275text(32, "Lieu ");
    \u0275\u0275elementStart(33, "span", 68);
    \u0275\u0275text(34, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(35, "input", 115);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "div", 67)(37, "label");
    \u0275\u0275text(38, "Description ");
    \u0275\u0275elementStart(39, "span", 68);
    \u0275\u0275text(40, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(41, "input", 116);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "div", 74)(43, "label");
    \u0275\u0275text(44, "Objectif Participant ");
    \u0275\u0275elementStart(45, "span", 68);
    \u0275\u0275text(46, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(47, "input", 117);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "div", 17)(49, "div", 67)(50, "label");
    \u0275\u0275text(51, "Date D\xE9but ");
    \u0275\u0275elementStart(52, "span", 68);
    \u0275\u0275text(53, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(54, "input", 118);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "div", 67)(56, "label");
    \u0275\u0275text(57, "Date Fin ");
    \u0275\u0275elementStart(58, "span", 68);
    \u0275\u0275text(59, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(60, "input", 119);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(61, "div", 17)(62, "div", 67)(63, "label");
    \u0275\u0275text(64, "Entite ");
    \u0275\u0275elementStart(65, "span", 68);
    \u0275\u0275text(66, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(67, "select", 120)(68, "option", 79);
    \u0275\u0275text(69, "-- S\xE9lectionnez une entite --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(70, ActivityComponent_ng_template_61_option_70_Template, 2, 2, "option", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(71, "div", 81)(72, "label");
    \u0275\u0275text(73, "Salle");
    \u0275\u0275elementStart(74, "span", 68);
    \u0275\u0275text(75, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(76, "select", 121)(77, "option", 79);
    \u0275\u0275text(78, "-- S\xE9lectionnez une salle --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(79, ActivityComponent_ng_template_61_option_79_Template, 2, 2, "option", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(80, "div", 81)(81, "label");
    \u0275\u0275text(82, "Type d'activite");
    \u0275\u0275elementStart(83, "span", 68);
    \u0275\u0275text(84, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(85, "select", 122)(86, "option", 79);
    \u0275\u0275text(87, "-- S\xE9lectionnez un type --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(88, ActivityComponent_ng_template_61_option_88_Template, 2, 2, "option", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(89, "div", 74)(90, "label");
    \u0275\u0275text(91, "Etape ");
    \u0275\u0275elementStart(92, "span", 68);
    \u0275\u0275text(93, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(94, "select", 123);
    \u0275\u0275listener("ngModelChange", function ActivityComponent_ng_template_61_Template_select_ngModelChange_94_listener($event) {
      \u0275\u0275restoreView(_r35);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onEtapesChange($event));
    });
    \u0275\u0275elementStart(95, "option", 79);
    \u0275\u0275text(96, "-- S\xE9lectionnez un ou plusieurs Etape --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(97, ActivityComponent_ng_template_61_option_97_Template, 2, 2, "option", 108);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(98, "div", 91)(99, "button", 94);
    \u0275\u0275listener("click", function ActivityComponent_ng_template_61_Template_button_click_99_listener() {
      const modal_r36 = \u0275\u0275restoreView(_r35).$implicit;
      return \u0275\u0275resetView(modal_r36.close("Close click"));
    });
    \u0275\u0275text(100, "Fermer");
    \u0275\u0275elementEnd()()()();
  }
    ...
    return __async(this, null, function* () {
      ...
      this.glogalService.post("activite", form.value).subscribe({
        next: (activite) => {
          ...
          if (superviseurId) {
            console.log(" Cr\xE9ation de validation pour superviseur :", superviseurId);
            const validation = {
            ...
            this.glogalService.createValidation(validation, fichier, "DESIGNATION").subscribe({
              next: () => {
                console.log(" Validation cr\xE9\xE9e !");
                this.addRecordSuccess();
                this.modalService.dismissAll();
                this.reloadActivities();
                form.reset();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ActivityComponent, selectors: [["app-activity"]], viewQuery: function ActivityComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(46, ActivityComponent_ng_template_46_Template, 3, 3, "ng-template", 35);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(57, ActivityComponent_ng_template_57_Template, 110, 21, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(59, ActivityComponent_ng_template_59_Template, 115, 24, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(61, ActivityComponent_ng_template_61_Template, 101, 10, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd()()()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(33);
     ...
     && register.get('dateFin')?.touched) 
{
  <small class="form-text text-danger"> La date fin ne peut pas \xEAtre ant\xE9rieure \xE0 la date d\xE9but.</small>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-2">
                    ...
                    <select class="form-select form-control" formControlName="superviseurId" (change)="onSuperviseurSelected($event)">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ActivityComponent, { className: "ActivityComponent", filePath: "src/app/personnels/activity/activity.component.ts", lineNumber: 45 });
})();
export {
  ActivityComponent
};
//# sourceMappingURL=activity.component-NLKKAW7O.js.map

...
var SidebarService = class _SidebarService {
   ...
   */
  getRouteInfo() {
    return this.http.get("assets/data/routes.json").pipe(map((response) => response.routes));
  }
  static {
...
function SidebarComponent_For_15_Conditional_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(7, SidebarComponent_For_15_Conditional_2_Conditional_1_For_8_Template, 3, 5, "li", 12, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r1 = \u0275\u0275nextContext(2).$implicit;
...
function SidebarComponent_For_15_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const item_r1 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275conditional(item_r1.submenu.length === 0 && item_r1.path !== "" ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r1.submenu.length > 0 ? 1 : -1);
  }
}
function SidebarComponent_For_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLinkActive", item_r1.submenu.length > 0 ? "active" : "active-top");
    \u0275\u0275advance();
...
var SidebarComponent = class _SidebarComponent {
  ...
  ngOnInit() {
    ...
    this.sidebarService.getRouteInfo().subscribe((routes) => {
      this.sidebarItems = routes.filter((item) => this.checkRoles(item.roles)).map((item) => __spreadProps(__spreadValues({}, item), {
  ...
  normalizeRoles(roles) {
    ...
    const normalized = roleArray.map((r) => String(r).trim().toUpperCase()).filter(Boolean);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 16, vars: 6, consts: [["id", "leftsidebar", 1, "sidebar", "main-sidebar"], [1, "sidebar-user-panel", "sidebar-user-panel--fixed"], [1, "user-panel"], [1, "image"], ["src", "assets/images/users/userhomme.png", "class", "img-circle user-img-circle", "alt", "User", 4, "ngIf"], ["src", "assets/images/users/userfemme.png", "class", "img-circle user-img-circle", "alt", "User", 4, "ngIf"], [1, "profile-usertitle"], [1, "sidebar-userpic-name"], [1, "profile-usertitle-job"], [1, "menu", "menu--scroll"], ["visibility", "hover"], [1, "list"], [3, "routerLinkActive"], ["src", "assets/images/users/userhomme.png", "alt", "User", 1, "img-circle", "user-img-circle"], ["src", "assets/images/users/userfemme.png", "alt", "User", 1, "img-circle", "user-img-circle"], [1, "header"], [1, "menu-top", 3, "routerLink"], [1, "sidebarIcon", 3, "name"], [1, "hide-menu"], ["href", "javascript:void(0)", 1, "menu-top", 3, "click"], [1, "chevron"], [1, "ml-menu"], [3, "routerLink"]], template: function SidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(14, SidebarComponent_For_15_Template, 3, 3, "li", 12, \u0275\u0275repeaterTrackByIdentity);
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
...
\r
  ...
  <div class="sidebar-user-panel sidebar-user-panel--fixed">\r
    ...
    <div class="profile-usertitle">\r
      ...
      <div class="profile-usertitle-job">{{ useRole }}</div>\r
    </div>\r
  </div>\r
\r
  <div class="menu menu--scroll">\r
    <ng-scrollbar [style.height]="listMaxHeight + 'px'" visibility="hover">\r
      <ul class="list">\r
        <!-- MENU ITEMS -->\r
        @for(item of sidebarItems; track item) {\r
          <li [routerLinkActive]="item.submenu.length > 0 ? 'active' : 'active-top'">\r
\r
            <!-- Group Title -->\r
...
\r
              ...
              @if(item.submenu.length === 0 && item.path !== '') {\r
...
\r
                <ul class="ml-menu" [style.display]="item.open ? 'block' : 'none'">\r
                  @for(sub of item.submenu; track sub) {\r
...
var APP_ROUTE = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadChildren: () => import("./dashboard.routes-BA5WBMDB.js").then((m) => m.DASHBOARD_ROUTE)
      },
      { path: "role", loadComponent: () => import("./role.component-NDG3HHT7.js").then((c) => c.RoleComponent) },
      { path: "utilisateur", loadComponent: () => import("./utilisateur.component-JQLBZREA.js").then((c) => c.UtilisateurComponent) },
      { path: "entite", loadComponent: () => import("./entite.component-OU45Y4TZ.js").then((c) => c.EntiteComponent) },
      {
        path: "entiteDetail",
        loadComponent: () => import("./entite-detail.component-LNZGB5FT.js").then((c) => c.EntiteDetailComponent)
      },
      { path: "dashboard2", loadComponent: () => import("./dashboard.component-BHPWXBGL.js").then((c) => c.DashboardComponent) },
      { path: "courrier", loadComponent: () => import("./courriers.component-NIQC7577.js").then((c) => c.CourriersComponent) },
      { path: "dashboardActivite", loadComponent: () => import("./dash-activite.component-XRFPOLI3.js").then((c) => c.DashActiviteComponent) },
      { path: "typeActivite", loadComponent: () => import("./type-activite.component-PSRDNRLU.js").then((c) => c.TypeActiviteComponent) },
      { path: "critere", loadComponent: () => import("./critere.component-Y624JFRO.js").then((c) => c.CritereComponent) },
      { path: "etape", loadComponent: () => import("./etape.component-Y24Y5IL6.js").then((c) => c.EtapeComponent) },
      {
        path: "listeDebut",
        loadComponent: () => import("./liste-debut.component-WZTTQGLF.js").then((c) => c.ListeDebutComponent)
      },
      {
        path: "listeGlobale",
        loadComponent: () => import("./liste-affichage.component-RLYJHY6H.js").then((c) => c.ListeAffichageComponent)
      },
      {
        path: "listeResultat",
        loadComponent: () => import("./liste-resultat.component-ET6GM7VA.js").then((c) => c.ListeResultatComponent)
      },
      { path: "activite", loadComponent: () => import("./activity.component-NLKKAW7O.js").then((c) => c.ActivityComponent) },
      { path: "salle", loadComponent: () => import("./salle.component-ZAXMGSAG.js").then((c) => c.SalleComponent) },
      { path: "activityvalidation", loadComponent: () => import("./activityvalidation.component-4LXF52OA.js").then((c) => c.ActivityvalidationComponent) },
      { path: "participant", loadComponent: () => import("./participant.component-CC6SJR2J.js").then((c) => c.ParticipantComponent) },
      { path: "supportactivites", loadComponent: () => import("./activitysupport.component-MBCYFCTP.js").then((c) => c.ActivitysupportComponent) },
      { path: "reporting", loadComponent: () => import("./reporting.component-5BKM3AL2.js").then((c) => c.ReportingComponent) },
      { path: "reportinghebdo", loadComponent: () => import("./reportinghebdo.component-FTAEFPMN.js").then((c) => c.ReportinghebdoComponent) },
      { path: "profile", loadComponent: () => import("./profile.component-KAFYDOGF.js").then((c) => c.ProfileComponent) }
    ]
  },
  {
    path: "authentication",
    component: AuthLayoutComponent,
    loadChildren: () => import("./auth.routes-DCMTQN4Z.js").then((m) => m.AUTH_ROUTE)
  },
